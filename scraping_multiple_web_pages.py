#A sample script to scrape the data from https://howpcrules.com/sample-page-for-web-scraping/ multiple times in a row and saving it to a MySQL database. This is just a simple example on how to scrape multiple pages.
#This tutorial was created for https://howpcrules.com/
